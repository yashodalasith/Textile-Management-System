...
function ViewProducts() {
    ...
    <span>Generate Report</span>
      ...
      <div className="mt-16 flex flex-wrap justify-center">
        {products.length > 0 && products.map((product) => (
          ...
          >
            <CardBody style={{ padding: '10px' }}> {/* Adjust padding here */}
              ...
              <div className="mt-2">
                  ...
                  <Typography variant="body2" className="text-left text-sm"> {/* Removed boldness */}
                    {product.color} 
                  </Typography>
                  <Typography variant="body2" className="text-sm">
  <div className="inline-block px-2 py-1 bg-white border border-gray-300 rounded" style={{ borderRadius: '4px', minWidth: '80px', textAlign: 'center' }}>
    {product.size}
  </div>
</Typography>
  ...
  {/* Price */}
  <div className="inline-block px-2 py-1 bg-white border border-gray-300 rounded" style={{ borderRadius: '4px', minWidth: '80px', textAlign: 'center', fontWeight: 'bold', fontSize: '16px', color: 'black' }}>
    ${product.price.toFixed(2)}
                ...
                {expandedProductId === product.productId && (
                  <div className="mt-4">
                    <Typography variant="body2" className="mb-2 text-left text-sm">
            ...
            <CardFooter className="p-0 flex items-center justify-between px-3 pb-6">
              ...
              >
                <PencilIcon className="w-5 h-5 mr-2 text-gray-700" /> {/* Edit icon */}
                Update
              </Button>
              <Button
              ...
              >
                <TrashIcon className="w-5 h-5 mr-2 text-red-500" /> {/* Delete icon */}
                Delete
              </Button>
            </CardFooter>
            <br />
